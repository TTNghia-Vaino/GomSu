...
public partial class GomsuContext : DbContext
{
    ...
    public virtual DbSet<_2fa> _2fas { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:GomsuContext");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<_2fa>(entity =>
        {
            entity.HasKey(e => new { e.MaTk, e.Code });
            ...
            entity.HasOne(d => d.MaTkNavigation).WithMany(p => p._2fas)
                .HasForeignKey(d => d.MaTk)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_2FA_TaiKhoan");
        });
